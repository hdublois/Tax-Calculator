...
def AGI(
    ...
    II_em, II_em_ps, II_prt, II_no_em_nu18, II_em_Ingram, e02300, UI_thd,
    UI_em, c00100, pre_c04600, c04600
):
    """
    ...
    II_em_Ingram: bool
        = True if Ingram flat tax with personal exemption amount per child
        under 18
    e02300: float
    ...
    if II_no_em_nu18 and not II_em_Ingram:  # repeal of personal exemptions for deps. under 18
        pre_c04600 = max(0, XTOT - nu18) * II_em
    elif not II_no_em_nu18 and not II_em_Ingram:
        pre_c04600 = XTOT * II_em
    elif II_em_Ingram:  # Ingram personal exemption amount
        pre_c04600 = nu18 * II_em
    if DSI:
        pre_c04600 = 0.
